...
console.log("Print this value ===>>>", obj1.fullAddress(), obj1.fullAddress.call(obj2));

// bind method example this method return a function and after that we can pass argument or can we call a function
const getFullAddress = obj1.fullAddress.bind(obj2);

console.log("Print bind method example", getFullAddress("arjun", "roy"));
